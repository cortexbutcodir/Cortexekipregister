...
if(!['838438333758570557'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
exports.conf = {enabled: true, guildOnly: true, aliases: ['kız', 'k', 'girl', 'women', 'kadın'], permLevel: 0}
exports.help = {name: 'kız', description: "Etiketlenen kişiyi kız rolleriyle kayıt eder.", usage: '.erkek @etiket/id İsim Yaş'}
